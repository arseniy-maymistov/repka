...
def count_letters(text):
    ...
    Returns:
        dict: Словарь, где ключи - буквы нижнего регистра, а значения - количество их вхождений.
    """
    letter_counts = {}
    for char in text:
        if char.isalpha():
...
def calculate_frequency(letter_counts):
    ...
    Args:
        letter_counts (dict): Словарь с буквами и их количеством.

    Returns:
        dict: Словарь, где ключи - буквы, а значения - их частоты.
    """
